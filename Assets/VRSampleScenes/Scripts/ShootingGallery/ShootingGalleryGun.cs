...
namespace VRStandardAssets.ShootingGallery
{
    ...
    public class ShootingGalleryGun : MonoBehaviour
    {
        ...
        [SerializeField] private Player player; // Reference to the player so the gun cannot fire whilst the game isn't playing.
        ...
        {
            // If the player has no health dont't do anything.
            if (player.Health <= 0)
                return;
            
            // Otherwise, if there is an interactible currently being looked at, try to find it's ShootingTarget component.
            Enemy shootingTarget = m_EyeRaycaster.CurrentInteractible ? m_EyeRaycaster.CurrentInteractible.GetComponent<Enemy>() : null;
            ...
            if (shootingTarget != null) shootingTarget.TakeDamage(25);
